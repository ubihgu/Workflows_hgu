...
util.log_to_process_file(process_id, source_me_id)
util.log_to_process_file(process_id, ms_instances)
 

ret = MSA_API.process_content('ENDED', 'MS Instances are {}'.format(ms_instances), context, True)
print(ret)